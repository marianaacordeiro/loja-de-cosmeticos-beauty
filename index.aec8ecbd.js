...
/*! cash-dom 1.3.5, https://github.com/kenwheeler/cash @license MIT */ (function(factory) {
    ...
    function cash1(selector, context) {
        return new Init(selector, context);
    }
    var fn = cash1.fn = cash1.prototype = Init.prototype = {
        cash: true,
        length: 0,
        push: push,
    ...
    cash1.parseHTML = parseHTML;
    cash1.noop = noop;
    cash1.isFunction = isFunction;
    cash1.isString = isString;
    cash1.extend = fn.extend = function(target) {
        target = target || {};
    ...
    function getCompareFunction(selector) {
        return /* Use browser's `matches` function if string */ isString(selector) ? matches : /* Match a cash element */ selector.cash ? function(el) {
    ...
    function unique(collection) {
        return cash1(slice.call(collection).filter(function(item, index, self) {
    ...
    var uid = cash1.uid = "_cash" + Date.now();
    ...
    function getData(node, key) {
        ...
        if (c[key] === undefined) c[key] = node.dataset ? node.dataset[key] : cash1(node).attr("data-" + key);
        return c[key];
    }
    function removeData(node, key) {
        ...
        else cash1(node).removeAttr("data-" + name);
    }
    fn.extend({
        data: function(name1, value) {
            if (isString(name1)) return value === undefined ? getData(this[0], name1) : this.each(function(v) {
                return setData(v, name1, value);
            });
            for(var key in name1)this.data(key, name1[key]);
            return this;
        },
    ...
    fn.extend({
        ...
        attr: function(name1, value) {
            if (!name1) return undefined;
            if (isString(name1)) {
                if (value === undefined) return this[0] ? this[0].getAttribute ? this[0].getAttribute(name1) : this[0][name1] : undefined;
                return this.each(function(v) {
                    if (v.setAttribute) v.setAttribute(name1, value);
                    else v[name1] = value;
                });
            }
            for(var key in name1)this.attr(key, name1[key]);
            return this;
        },
        hasClass: function(c) {
        ...
        prop: function(name1, value) {
            if (isString(name1)) return value === undefined ? this[0][name1] : this.each(function(v) {
                v[name1] = value;
            });
            for(var key in name1)this.prop(key, name1[key]);
            return this;
        },
        removeAttr: function(name1) {
            return this.each(function(v) {
                if (v.removeAttribute) v.removeAttribute(name1);
                else delete v[name1];
            });
        },
    ...
    fn.extend({
        add: function(selector, context) {
            return unique(cash1.merge(this, cash1(selector, context)));
        },
        ...
        eq: function(index) {
            return cash1(this.get(index));
        },
        filter: function(selector) {
            if (!selector) return this;
            var comparator = isFunction(selector) ? selector : getCompareFunction(selector);
            return cash1(filter.call(this, function(e) {
        ...
        index: function(elem) {
            var child = elem ? cash1(elem)[0] : this[0], collection = elem ? this : cash1(child).parent().children();
    ...
    cash1.prefixedProp = getPrefixedProp;
    cash1.camelCase = camelCase;
    fn.extend({
    ...
    function encode(name1, value) {
        return "&" + encodeURIComponent(name1) + "=" + encodeURIComponent(value).replace(/%20/g, "+");
    }
                ...
                switch(el.type.toLowerCase()){
                    ...
                    case "select-multiple":
                        ...
                        if (values !== null) each(values, function(value) {
                            query += encode(name1, value);
                        });
                        break;
                    default:
                        var value = getValue(el);
                        if (value !== null) query += encode(name1, value);
                }
            });
    ...
    fn.extend({
        after: function(selector) {
            cash1(selector).insertAfter(this);
            return this;
        },
        ...
        appendTo: function(parent) {
            insertContent(cash1(parent), this);
            return this;
        },
        before: function(selector) {
            cash1(selector).insertBefore(this);
            return this;
        },
        clone: function() {
            return cash1(this.map(function(v) {
        ...
        insertAfter: function(selector) {
            var _this = this;
            cash1(selector).each(function(el, i) {
        ...
        prependTo: function(parent) {
            insertContent(cash1(parent), this, true);
            return this;
        },
        remove: function() {
            return this.each(function(v) {
    ...
    fn.extend({
        ...
        offsetParent: function() {
            return cash1(this[0].offsetParent);
        }
    });
    fn.extend({
        ...
        closest: function(selector) {
            if (!selector || this.length < 1) return cash1();
        ...
        find: function(selector) {
            if (!selector || selector.nodeType) return cash1(selector && this.has(selector).length ? selector : null);
            var elems = [];
            this.each(function(el) {
        ...
        next: function() {
            return cash1(this[0].nextElementSibling);
        },
        ...
        prev: function() {
            return cash1(this[0].previousElementSibling);
        },
...
(function(window1) {
    if (window1.Package) M = {};
    else window1.M = {};
    // Check for jQuery
    M.jQueryLoaded = !!window1.jQuery;
})(window);
// AMD
...
(function(r) {
    ...
    function N(a) {
        ...
        switch(a.tagName.toLowerCase()){
            ...
            case "polygon":
                var c = a.points;
                return M1(a) + F(c.getItem(c.numberOfItems - 1), c.getItem(0));
        }
    }
    function Y(a, c) {
        function d(b) {
...
(function($1, anim) {
   ...
   */ var Collapsible = function(_Component) {
     ...
     */ function Collapsible(el, options) {
       ...
       */ _this3.options = $1.extend({}, Collapsible.defaults, options);
            // Setup tab indices
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _handleCollapsibleClick(e) {
                    var $header = $1(e.target).closest('.collapsible-header');
                    ...
                    if ($collapsibleLi.length && !$collapsibleLi[0].classList.contains('active')) {
                        ...
                        if (this.options.accordion) {
                            ...
                            $activeLis.each(function(el) {
                                var index = $collapsibleLis.index($1(el));
                                _this8.close(index);
                            });
                        }
                        // Animate in
...
(function($1, anim) {
   ...
   */ var Dropdown = function(_Component2) {
        ...
        function Dropdown(el, options) {
            ...
            _this9.$dropdownEl = $1(_this9.dropdownEl);
            /**
       ...
       */ _this9.options = $1.extend({}, Dropdown.defaults, options);
            /**
       ...
       */ _this9.isTouchMoving = false;
            ...
            if (!!_this9.options.container) $1(_this9.options.container).append(_this9.dropdownEl);
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _handleMouseLeave(e) {
                    ...
                    var leaveToDropdownContent = !!$1(toEl).closest('.dropdown-content').length;
                    var leaveToActiveDropdownTrigger = false;
                    var $closestTrigger = $1(toEl).closest('.dropdown-trigger');
            ...
            },
            {
                ...
                value: function _handleDropdownClick(e) {
                    ...
                    if (typeof this.options.onItemClick === 'function') {
                        var itemEl = $1(e.target).closest('li')[0];
            ...
            },
            {
                ...
                value: function _handleDropdownKeydown(e) {
                    ...
                    // ENTER selects choice on focused item
                        ...
                        var $activatableElement = $1(focusedElement).find('a, button').first();
                    ...
                    if (letter && nonLetters.indexOf(e.which) === -1) {
                        ...
                        var string = this.filterQuery.join(''), newOptionEl = $1(this.dropdownEl).find('li').filter(function(el) {
                            return $1(el).text().toLowerCase().indexOf(string) === 0;
                        })[0];
                        if (newOptionEl) {
                            this.focusedIndex = $1(newOptionEl).index();
                            this._focusFocusedItem();
                        }
                    }
            ...
            },
            {
                ...
                value: function _makeDropdownFocusable() {
                    ...
                    $1(this.dropdownEl).children().each(function(el) {
...
(function($1, anim) {
   ...
   */ var Modal = function(_Component3) {
     ...
     */ function Modal(el, options) {
       ...
       */ _this13.options = $1.extend({}, Modal.defaults, options);
            /**
       ...
       */ _this13.isOpen = false;
            ...
            _this13.$overlay = $1('<div class="modal-overlay"></div>');
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _handleTriggerClick(e) {
                    var $trigger = $1(e.target).closest('.modal-trigger');
                    if ($trigger.length) {
            ...
            },
            {
                ...
                value: function _handleModalCloseClick(e) {
                    var $closeTrigger = $1(e.target).closest('.modal-close');
            ...
            },
            {
                ...
                value: function _animateIn() {
                    var _this14 = this;
                    // Set initial styles
                    $1.extend(this.el.style, {
                        display: 'block',
                        opacity: 0
                    });
                    $1.extend(this.$overlay[0].style, {
                        display: 'block',
                        opacity: 0
                    });
                    // Animate overlay
...
(function($1, anim) {
   ...
   */ var Materialbox = function(_Component4) {
     ...
     */ function Materialbox(el, options) {
       ...
       */ _this16.options = $1.extend({}, Materialbox.defaults, options);
            _this16.overlayActive = false;
            _this16.doneAnimating = true;
            _this16.placeholder = $1('<div></div>').addClass('material-placeholder');
       ...
       */ value: function destroy() {
                    ...
                    // Unwrap image
                    $1(this.placeholder).after(this.el).remove();
            ...
            },
            {
                ...
                value: function open() {
                    ...
                    // Add overlay
                    this.$overlay = $1('<div id="materialbox-overlay"></div>').css({
                        opacity: 0
                    }).one('click', function() {
                    ...
                    if (this.caption !== '') {
                        ...
                        this.$photoCaption = $1('<div class="materialbox-caption"></div>');
                        this.$photoCaption.text(this.caption);
                        $1('body').append(this.$photoCaption);
...
(function($1) {
    ...
    var Parallax = function(_Component5) {
       ...
       */ _this21.options = $1.extend({}, Parallax.defaults, options);
            _this21._enabled = window.innerWidth > _this21.options.responsiveThreshold;
            _this21.$img = _this21.$el.find('img').first();
            _this21.$img.each(function() {
                var el = this;
                if (el.complete) $1(el).trigger('load');
            });
...
(function($1, anim) {
   ...
   */ var Tabs = function(_Component6) {
     ...
     */ function Tabs(el, options) {
       ...
       * @prop {Number} responsiveThreshold
       */ _this22.options = $1.extend({}, Tabs.defaults, options);
            // Setup
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _handleTabClick(e) {
                    var _this23 = this;
                    var tab = $1(e.target).closest('li.tab');
                    var tabLink = $1(e.target).closest('a');
                    ...
                    this.$content = $1(M.escapeHash(tabLink[0].hash));
            ...
            },
            {
                ...
                value: function _setupActiveTabLink() {
                    ...
                    this.$activeTabLink = $1(this.$tabLinks.filter('[href="' + location.hash + '"]'));
                    ...
                    if (this.$activeTabLink.length) {
                        this.$content = $1(M.escapeHash(this.$activeTabLink[0].hash));
                        this.$content.addClass('active');
                    }
                }
            },
            {
                ...
                value: function _setupSwipeableTabs() {
                    ...
                    this.$tabLinks.each(function(link) {
                        var $currContent = $1(M.escapeHash(link.hash));
                        $currContent.addClass('carousel-item');
                        $tabsContent = $tabsContent.add($currContent);
                    });
                    var $tabsWrapper = $1('<div class="tabs-content carousel carousel-slider"></div>');
...
(function($1, anim) {
   ...
   */ var Tooltip = function(_Component7) {
     ...
     */ function Tooltip(el, options) {
            ...
            _this26.options = $1.extend({}, Tooltip.defaults, options);
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function open(isManual) {
                    ...
                    this.options = $1.extend({}, this.options, this._getAttributeOptions());
...
(function(window1) {
   ...
   */ function showEffect(e) {
    ...
    Waves.displayEffect = function(options) {
        ...
        if ('ontouchstart' in window1) document.body.addEventListener('touchstart', showEffect, false);
   ...
   */ Waves.attach = function(element) {
        ...
        if ('ontouchstart' in window1) element.addEventListener('touchstart', showEffect, false);
...
(function($1, anim) {
    ...
    var Toast = function() {
       ...
       */ this.options = $1.extend({}, Toast.defaults, options);
       ...
       */ value: function _createToast() {
                    ...
                    if (!!this.options.classes.length) $1(toast).addClass(this.options.classes);
                    // Set content
                    ...
                    else if (!!this.message.jquery) $1(toast).append(this.message[0]);
       ...
       */ value: function getInstance(el) {
            ...
            },
            {
                ...
                value: function _onDragStart(e) {
                    if (e.target && $1(e.target).closest('.toast').length) {
                        var $toast = $1(e.target).closest('.toast');
...
(function($1, anim) {
   ...
   */ var Sidenav = function(_Component8) {
     ...
     */ function Sidenav(el, options) {
       ...
       */ _this31.options = $1.extend({}, Sidenav.defaults, options);
            /**
       ...
       */ value: function destroy() {
            ...
            },
            {
                key: "_handleTriggerClick",
                value: function _handleTriggerClick(e) {
                    var $trigger = $1(e.target).closest('.sidenav-trigger');
         ...
         */ var transformX = totalDeltaX;
            ...
            },
            {
                ...
                value: function _handleCloseTriggerClick(e) {
                    var $closeTrigger = $1(e.target).closest('.sidenav-close');
            ...
            },
            {
                ...
                value: function _animateOverlayOut() {
                    ...
                    anim({
                        ...
                        easing: 'easeOutQuad',
                        complete: function() {
                            $1(_this34._overlay).css('display', 'none');
                        }
                    });
                }
            }
...
(function($1, anim) {
   ...
   */ var ScrollSpy = function(_Component9) {
     ...
     */ function ScrollSpy(el, options) {
       ...
       */ _this35.options = $1.extend({}, ScrollSpy.defaults, options);
            // setup
       ...
       */ value: function destroy() {
                    ...
                    ScrollSpy._count--;
                    this._removeEventHandlers();
                    $1(this.options.getActiveElement(this.$el.attr('id'))).removeClass(this.options.activeClass);
            ...
            },
            {
                ...
                value: function _enter() {
                    ...
                    if (ScrollSpy._visibleElements[0]) {
                        $1(this.options.getActiveElement(ScrollSpy._visibleElements[0].attr('id'))).removeClass(this.options.activeClass);
                    ...
                    $1(this.options.getActiveElement(ScrollSpy._visibleElements[0].attr('id'))).addClass(this.options.activeClass);
                }
            },
            {
                key: "_exit",
...
(function($1) {
   ...
   */ var Autocomplete = function(_Component10) {
     ...
     */ function Autocomplete(el, options) {
       ...
       */ _this37.options = $1.extend({}, Autocomplete.defaults, options);
            // Setup
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _setupDropdown() {
                    ...
                    $1(this.container).addClass('autocomplete-content dropdown-content');
            ...
            },
            {
                ...
                value: function _handleInputKeydown(e) {
                    ...
                    var keyCode = e.keyCode, liElement = void 0, numItems = $1(this.container).children('li').length;
                    // select element on Enter
                    if (keyCode === M.keys.ENTER && this.activeIndex >= 0) {
                        liElement = $1(this.container).children('li').eq(this.activeIndex);
                        if (liElement.length) {
                    ...
                    if (keyCode === M.keys.ARROW_UP || keyCode === M.keys.ARROW_DOWN) {
                        ...
                        if (this.activeIndex >= 0) {
                            this.$active = $1(this.container).children('li').eq(this.activeIndex);
            ...
            },
            {
                ...
                value: function _renderDropdown(data, val) {
                    ...
                    for(var i = 0; i < matchingData.length; i++){
                        ...
                        var $autocompleteOption = $1('<li></li>');
                        ...
                        $1(this.container).append($autocompleteOption);
...
(function($1) {
    ...
    M.updateTextFields = function() {
        ...
        $1(input_selector).each(function(element, index) {
            var $this = $1(this);
            if (element.value.length > 0 || $1(element).is(':focus') || element.autofocus || $this.attr('placeholder') !== null) $this.siblings('label').addClass('active');
    ...
    M.textareaAutoResize = function($textarea) {
        ...
        if ($textarea instanceof Element) $textarea = $1($textarea);
        if (!$textarea.length) {
    ...
    $1(document).ready(function() {
        ...
        $1(document).on('change', input_selector, function() {
            if (this.value.length !== 0 || $1(this).attr('placeholder') !== null) $1(this).siblings('label').addClass('active');
            M.validate_field($1(this));
        });
        ...
        $1(document).on('reset', function(e) {
            ...
            if (formReset.is('form')) {
                ...
                formReset.find(input_selector).each(function(e) {
                    if (this.value.length) $1(this).siblings('label').removeClass('active');
                });
                // Reset select (after native reset)
                setTimeout(function() {
                    formReset.find('select').each(function() {
                        // check if initialized
                        if (this.M_FormSelect) $1(this).trigger('change');
                    });
                }, 0);
            }
        });
     ...
     */ document.addEventListener('focus', function(e) {
            if ($1(e.target).is(input_selector)) $1(e.target).siblings('label, .prefix').addClass('active');
        }, true);
        /**
     * Remove active when element is blurred
     * @param {Event} e
     */ document.addEventListener('blur', function(e) {
            var $inputElement = $1(e.target);
        ...
        $1(document).on('keyup', radio_checkbox, function(e) {
       ...
       */ $textarea.data('original-height', $textarea.height());
        ...
        $1(document).on('keyup', text_area_selector, function() {
            M.textareaAutoResize($1(this));
        });
        $1(document).on('keydown', text_area_selector, function() {
            M.textareaAutoResize($1(this));
        });
        // File Input Path
...
(function($1, anim) {
   ...
   */ var Slider = function(_Component11) {
     ...
     */ function Slider(el, options) {
       ...
       */ _this40.options = $1.extend({}, Slider.defaults, options);
            // setup
            _this40.$slider = _this40.$el.find('.slides');
            _this40.$slides = _this40.$slider.children('li');
            _this40.activeIndex = _this40.$slides.filter(function(item) {
                return $1(item).hasClass('active');
            }).first().index();
            ...
            _this40.$slides.find('img').each(function(el) {
                ...
                if ($1(el).attr('src') !== placeholderBase64) {
                    $1(el).css('background-image', 'url("' + $1(el).attr('src') + '")');
                    $1(el).attr('src', placeholderBase64);
                }
            });
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _handleIndicatorClick(e) {
                    var currIndex = $1(e.target).index();
                    this.set(currIndex);
                }
            },
            {
            ...
            },
            {
                ...
                value: function _animateCaptionIn(caption, duration) {
                    ...
                    if ($1(caption).hasClass('center-align')) animOptions.translateY = -100;
                    else if ($1(caption).hasClass('right-align')) animOptions.translateX = 100;
                    else if ($1(caption).hasClass('left-align')) animOptions.translateX = -100;
                    anim(animOptions);
                }
            },
            {
            ...
            },
            {
                ...
                value: function _setupIndicators() {
                    ...
                    if (this.options.indicators) {
                        this.$indicators = $1('<ul class="indicators"></ul>');
                        this.$slides.each(function(el, index) {
                            var $indicator = $1('<li class="indicator-item"></li>');
...
(function($1, anim) {
    $1(document).on('click', '.card', function(e) {
        if ($1(this).children('.card-reveal').length) {
            ...
            var $cardReveal = $1(this).find('.card-reveal');
            if ($1(e.target).is($1('.card-reveal .card-title')) || $1(e.target).is($1('.card-reveal .card-title i'))) // Make Reveal animate down and display none
            anim({
...
(function($1) {
   ...
   */ var Chips = function(_Component12) {
     ...
     */ function Chips(el, options) {
       ...
       */ _this45.options = $1.extend({}, Chips.defaults, options);
       ...
       */ value: function getData() {
            ...
            },
            {
                ...
                value: function _handleChipClick(e) {
                    var $chip = $1(e.target).closest('.chip');
                    var clickedClose = $1(e.target).is('.close');
                    if ($chip.length) {
       ...
       */ value: function _handleInputFocus() {
            ...
            },
            {
                ...
                value: function _renderChip(chip) {
                    ...
                    $1(closeIcon).addClass('material-icons close');
            ...
            },
            {
                ...
                value: function _setPlaceholder() {
                    if (this.chipsData !== undefined && !this.chipsData.length && this.options.placeholder) $1(this.$input).prop('placeholder', this.options.placeholder);
                    else if ((this.chipsData === undefined || !!this.chipsData.length) && this.options.secondaryPlaceholder) $1(this.$input).prop('placeholder', this.options.secondaryPlaceholder);
                }
            },
            {
                key: "_isValid",
            ...
            },
            {
                ...
                value: function addChip(chip) {
                    ...
                    $1(this.$input).before(renderedChip);
            ...
            },
            {
                ...
                value: function _handleChipsKeydown(e) {
                    Chips._keydown = true;
                    var $chips = $1(e.target).closest('.chips');
                    var chipsKeydown = e.target && $chips.length;
                    // Don't handle keydown inputs on input and textarea
                    if ($1(e.target).is('input, textarea') || !chipsKeydown) return;
   ...
   */ Chips._keydown = false;
    ...
    $1(document).ready(function() {
        ...
        $1(document.body).on('click', '.chip .close', function() {
            var $chips = $1(this).closest('.chips');
            if ($chips.length && $chips[0].M_Chips) return;
            $1(this).closest('.chip').remove();
        });
    });
})(cash);
(function($1) {
   ...
   */ var Pushpin = function(_Component13) {
     ...
     */ function Pushpin(el, options) {
       ...
       */ _this47.options = $1.extend({}, Pushpin.defaults, options);
...
(function($1, anim) {
   ...
   */ var FloatingActionButton = function(_Component14) {
     ...
     */ function FloatingActionButton(el, options) {
       ...
       */ _this48.options = $1.extend({}, FloatingActionButton.defaults, options);
       ...
       */ value: function destroy() {
            ...
            },
            {
                key: "_handleDocumentClick",
                value: function _handleDocumentClick(e) {
                    if (!$1(e.target).closest(this.$menu).length) this.close();
                }
            },
            {
                key: "open",
            ...
            },
            {
                ...
                value: function _animateInToolbar() {
                    ...
                    var backdrop = $1('<div class="fab-backdrop"></div>');
...
(function($1) {
   ...
   */ var Datepicker = function(_Component15) {
     ...
     */ function Datepicker(el, options) {
            ...
            _this53.options = $1.extend({}, Datepicker.defaults, options);
            // make sure i18n defaults are not lost when only few i18n option properties are passed
            if (!!options && options.hasOwnProperty('i18n') && typeof options.i18n === 'object') _this53.options.i18n = $1.extend({}, Datepicker.defaults.i18n, options.i18n);
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _setupVariables() {
                    var _this56 = this;
                    this.$modalEl = $1(Datepicker._template);
...
(function($1) {
   ...
   */ var Timepicker = function(_Component16) {
        ...
        function Timepicker(el, options) {
            ...
            _this57.options = $1.extend({}, Timepicker.defaults, options);
            _this57.id = M.guid();
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _setupEventHandlers() {
                    ...
                    $1(this.spanHours).on('click', this.showView.bind(this, 'hours'));
                    $1(this.spanMinutes).on('click', this.showView.bind(this, 'minutes'));
                }
            },
            {
                key: "_removeEventHandlers",
            ...
            },
            {
                ...
                value: function _handleDocumentClickEnd(e) {
                    ...
                    if (this.currentView === 'hours') this.showView('minutes', this.options.duration / 2);
                        ...
                        $1(this.minutesView).addClass('timepicker-dial-out');
                        setTimeout(function() {
                            _this58.done();
            ...
            },
            {
                key: "_insertHTMLIntoDOM",
                value: function _insertHTMLIntoDOM() {
                    this.$modalEl = $1(Timepicker._template);
                    this.modalEl = this.$modalEl[0];
                    this.modalEl.id = 'modal-' + this.id;
            ...
            },
            {
                ...
                value: function _pickerSetup() {
                    var $clearBtn = $1("<button class=\"btn-flat timepicker-clear waves-effect\" style=\"visibility: hidden;\" type=\"button\" tabindex=\"" + (this.options.twelveHour ? '3' : '1') + "\">" + this.options.i18n.clear + "</button>").appendTo(this.footer).on('click', this.clear.bind(this));
                    if (this.options.showClearBtn) $clearBtn.css({
                        visibility: ''
                    });
                    var confirmationBtnsContainer = $1('<div class="confirmation-btns"></div>');
                    $1('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.cancel + '</button>').appendTo(confirmationBtnsContainer).on('click', this.close.bind(this));
                    $1('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? '3' : '1') + '">' + this.options.i18n.done + '</button>').appendTo(confirmationBtnsContainer).on('click', this.done.bind(this));
            ...
            },
            {
                ...
                value: function _clockSetup() {
                    if (this.options.twelveHour) {
                        this.$amBtn = $1('<div class="am-btn">AM</div>');
                        this.$pmBtn = $1('<div class="pm-btn">PM</div>');
            ...
            },
            {
                ...
                value: function _buildHoursView() {
                    var $tick = $1('<div class="timepicker-tick"></div>');
                    // Hours view
            ...
            },
            {
                ...
                value: function showView(view, delay) {
                    view === 'minutes' && $1(this.hoursView).css('visibility');
                    ...
                    $1(this.spanHours).toggleClass('text-primary', isHours);
                    $1(this.spanMinutes).toggleClass('text-primary', !isHours);
                    // Transition view
                    hideView.classList.add('timepicker-dial-out');
                    $1(nextView).css('visibility', 'visible').removeClass('timepicker-dial-out');
                    // Reset clock hand
                    this.resetClock(delay);
                    // After transitions ended
                    clearTimeout(this.toggleViewTimer);
                    this.toggleViewTimer = setTimeout(function() {
                        $1(hideView).css('visibility', 'hidden');
            ...
            },
            {
                ...
                value: function resetClock(delay) {
                    ...
                    if (delay) {
                        $1(this.canvas).addClass('timepicker-canvas-out');
                        setTimeout(function() {
                            $1(self.canvas).removeClass('timepicker-canvas-out');
                            self.setHand(x, y);
                        }, delay);
            ...
            {
                key: "_createSVGEl",
                value: function _createSVGEl(name1) {
                    var svgNS = 'http://www.w3.org/2000/svg';
                    return document.createElementNS(svgNS, name1);
                }
            },
            {
                key: "_Pos",
...
(function($1) {
   ...
   */ var CharacterCounter = function(_Component17) {
     ...
     */ function CharacterCounter(el, options) {
       ...
       */ _this61.options = $1.extend({}, CharacterCounter.defaults, options);
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _setupCounter() {
                    ...
                    $1(this.counterEl).addClass('character-counter').css({
                        float: 'right',
                        'font-size': '12px',
                        height: 1
                    });
            ...
            },
            {
                ...
                value: function updateCounter() {
                    ...
                    $1(this.counterEl).html(counterString);
                }
            },
            {
                key: "_validateInput",
...
(function($1) {
   ...
   */ var Carousel = function(_Component18) {
     ...
     */ function Carousel(el, options) {
       ...
       * @prop {Boolean} noWrap
       * @prop {Function} onCycleTo
       */ _this62.options = $1.extend({}, Carousel.defaults, options);
            // Setup
            ...
            _this62.$indicators = $1('<ul class="indicators"></ul>');
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _handleCarouselTap(e) {
                    ...
                    if (e.type === 'mousedown' && $1(e.target).is('img')) e.preventDefault();
                    this.pressed = true;
                    this.dragged = false;
            ...
            },
            {
                ...
                value: function _handleCarouselClick(e) {
                    ...
                    if (this.dragged) {
                        ...
                        var clickedIndex = $1(e.target).closest('.carousel-item').index();
            ...
            },
            {
                ...
                value: function _handleIndicatorClick(e) {
                    e.stopPropagation();
                    var indicator = $1(e.target).closest('.indicator-item');
...
(function($1) {
   ...
   */ var TapTarget = function(_Component19) {
     ...
     */ function TapTarget(el, options) {
       ...
       */ _this67.options = $1.extend({}, TapTarget.defaults, options);
            _this67.isOpen = false;
            // setup
            _this67.$origin = $1('#' + _this67.$el.attr('data-target'));
            _this67._setup();
       ...
       */ value: function destroy() {
            ...
            },
            {
                key: "_handleDocumentClick",
                value: function _handleDocumentClick(e) {
                    if (!$1(e.target).closest('.tap-target-wrapper').length) {
                        this.close();
                        e.preventDefault();
                        e.stopPropagation();
                    }
            ...
            },
            {
                ...
                value: function _setup() {
                    ...
                    this.waveEl = $1(this.wrapper).find('.tap-target-wave')[0];
                    this.originEl = $1(this.wrapper).find('.tap-target-origin')[0];
                    this.contentEl = this.$el.find('.tap-target-content')[0];
                    // Creating wrapper
                    if (!$1(this.wrapper).hasClass('.tap-target-wrapper')) {
                        this.wrapper = document.createElement('div');
                        this.wrapper.classList.add('tap-target-wrapper');
                        this.$el.before($1(this.wrapper));
                ...
                value: function _calculatePositioning() {
                    ...
                    if (!isFixed) {
                        ...
                        for(var i = 0; i < parents.length; i++){
                            isFixed = $1(parents[i]).css('position') == 'fixed';
                            if (isFixed) break;
                        }
                    }
                    // Calculating origin
                    ...
                    $1(this.wrapper).css(tapTargetWrapperCssObj);
                    // Setting content
                    $1(this.contentEl).css({
...
(function($1) {
   ...
   */ var FormSelect = function(_Component20) {
     ...
     */ function FormSelect(el, options) {
       ...
       */ _this68.options = $1.extend({}, FormSelect.defaults, options);
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _setupEventHandlers() {
                    ...
                    this._handleInputClickBound = this._handleInputClick.bind(this);
                    $1(this.dropdownOptions).find('li:not(.optgroup)').each(function(el) {
            ...
            },
            {
                ...
                value: function _handleOptionClick(e) {
                    e.preventDefault();
                    var option = $1(e.target).closest('li')[0];
                    var key = option.id;
                    if (!$1(option).hasClass('disabled') && !$1(option).hasClass('optgroup') && key.length) {
                        var selected = true;
                        if (this.isMultiple) {
                            // Deselect placeholder option if still selected.
                            var placeholderOption = $1(this.dropdownOptions).find('li.disabled.selected');
                            ...
                            $1(this.dropdownOptions).find('li').removeClass('selected');
                            $1(option).toggleClass('selected', selected);
                        }
                        // Set selected on original select option
                        // Only trigger if selected state changed
                        var prevSelected = $1(this._valueDict[key].el).prop('selected');
                        if (prevSelected !== selected) {
                            $1(this._valueDict[key].el).prop('selected', selected);
                            this.$el.trigger('change');
                        }
                    }
                    e.stopPropagation();
            ...
            },
            {
                ...
                value: function _setupDropdown() {
                    var _this71 = this;
                    this.wrapper = document.createElement('div');
                    $1(this.wrapper).addClass('select-wrapper ' + this.options.classes);
                    this.$el.before($1(this.wrapper));
                    ...
                    $1(this.dropdownOptions).addClass('dropdown-content select-dropdown ' + (this.isMultiple ? 'multiple-select-dropdown' : ''));
                    // Create dropdown structure.
                    if (this.$selectOptions.length) this.$selectOptions.each(function(el) {
                        if ($1(el).is('option')) {
                            // Direct descendant option.
                            var optionEl = void 0;
                            if (_this71.isMultiple) optionEl = _this71._appendOptionWithIcon(_this71.$el, el, 'multiple');
                            else optionEl = _this71._appendOptionWithIcon(_this71.$el, el);
                            _this71._addOptionToValueDict(el, optionEl);
                        } else if ($1(el).is('optgroup')) {
                            // Optgroup.
                            var selectOptions = $1(el).children('option');
                            $1(_this71.dropdownOptions).append($1('<li class="optgroup"><span>' + el.getAttribute('label') + '</span></li>')[0]);
                    ...
                    $1(this.input).addClass('select-dropdown dropdown-trigger');
                    this.input.setAttribute('type', 'text');
                    this.input.setAttribute('readonly', 'true');
                    this.input.setAttribute('data-target', this.dropdownOptions.id);
                    if (this.el.disabled) $1(this.input).prop('disabled', 'true');
                    this.$el.before(this.input);
                    this._setValueToInput();
                    // Add caret
                    var dropdownIcon = $1('<svg class="caret" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/><path d="M0 0h24v24H0z" fill="none"/></svg>');
                    this.$el.before(dropdownIcon[0]);
                    // Initialize dropdown
                    if (!this.el.disabled) {
                        var dropdownOptions = $1.extend({}, this.options.dropdownOptions);
                        // Add callback for centering selected option when dropdown content is scrollable
                        dropdownOptions.onOpenEnd = function(el) {
                            var selectedOption = $1(_this71.dropdownOptions).find('.selected').first();
            ...
            },
            {
                key: "_removeDropdown",
                value: function _removeDropdown() {
                    $1(this.wrapper).find('.caret').remove();
                    $1(this.input).remove();
                    $1(this.dropdownOptions).remove();
                    $1(this.wrapper).before(this.$el);
                    $1(this.wrapper).remove();
                }
            },
            {
                ...
                value: function _appendOptionWithIcon(select, option, type) {
                    ...
                    if (!!iconUrl) {
                        var imgEl = $1("<img alt=\"\" src=\"" + iconUrl + "\">");
                        liEl.prepend(imgEl);
                    }
                    // Check for multiple type.
                    $1(this.dropdownOptions).append(liEl[0]);
                    return liEl[0];
                }
            },
            {
                ...
                value: function _toggleEntryFromArray(key) {
                    ...
                    var $optionLi = $1(this._valueDict[key].optionEl);
            ...
            },
            {
                ...
                value: function _setSelectedStates() {
                    ...
                    for(var key in this._valueDict){
                        ...
                        var optionIsSelected = $1(option.el).prop('selected');
                        $1(option.optionEl).find('input[type="checkbox"]').prop('checked', optionIsSelected);
                        if (optionIsSelected) {
                            this._activateOption($1(this.dropdownOptions), $1(option.optionEl));
                            this._keysSelected[key] = true;
                        } else $1(option.optionEl).removeClass('selected');
                    }
                }
            },
            {
...
(function($1, anim) {
   ...
   */ var Range = function(_Component21) {
     ...
     */ function Range(el, options) {
       ...
       */ _this72.options = $1.extend({}, Range.defaults, options);
       ...
       */ value: function destroy() {
            ...
            },
            {
                ...
                value: function _handleRangeChange() {
                    $1(this.value).html(this.$el.val());
                    if (!$1(this.thumb).hasClass('active')) this._showRangeBubble();
                    var offsetLeft = this._calcRangeOffset();
                    $1(this.thumb).addClass('active').css('left', offsetLeft + 'px');
                }
            },
            {
            ...
            },
            {
                ...
                value: function _handleRangeBlurMouseoutTouchleave() {
                    if (!this._mousedown) {
                        ...
                        if ($1(this.thumb).hasClass('active')) {
                        ...
                        $1(this.thumb).removeClass('active');
                    }
                }
            },
            {
                ...
                value: function _setupThumb() {
                    ...
                    $1(this.thumb).addClass('thumb');
                    $1(this.value).addClass('value');
                    $1(this.thumb).append(this.value);
            ...
            },
            {
                ...
                value: function _showRangeBubble() {
                    var paddingLeft = parseInt($1(this.thumb).parent().css('padding-left'));
    ...
    Range.init($1('input[type=range]'));
})(cash, M.anime);

//# sourceMappingURL=index.aec8ecbd.js.map
